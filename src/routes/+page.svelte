    ...
    <div class="flex flex-col bg-white border-2 border-gray-400 rounded-b-lg">
      {#each appState.items as item, index}
        <div class="flex items-center gap-2 p-2 border-b border-gray-300">
          ...
          />
          <input
            class="w-16 border-2 border-gray-300 rounded-md p-2 text-center focus:outline-none focus:border-gray-500"
            type="number"
            min="0"
            step="1"
          ...
          <div class="flex items-center">
            <span class="mr-1">{getCurrencySymbol(appState.currency)}</span>
            <input
              class="w-20 border-2 border-gray-300 rounded-md p-2 text-right focus:outline-none focus:border-gray-500"
              type="number"
              min="0"
              step="0.01"
          ...
          <button
            ...
            class="p-2 hover:bg-gray-200 rounded print:hidden"
          >
            <Trash />
          </button>
        </div>
